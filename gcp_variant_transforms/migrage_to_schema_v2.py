...
r"""A simple tool for migrating existing V1 tables to V2 schema.

Run locally:
python -m gcp_variant_transforms.migrate_to_schema_v2 \
  --input_table projectname:bigquerydataset.input_table_name \
  --output_table_base_name projectname:bigquerydataset.output_table_base_name \
  --config_file ../data/partition_configs/homo_sapiens_default.yaml
"""
